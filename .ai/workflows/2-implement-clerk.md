---
description: Implement thư viện clerk cho chức năng authentication
---
...
## Quy trình thực hiện
1. **Lập kế hoạch**: Phân tích UI và yêu cầu tích hợp Clerk. **Lập kế hoạch thực hiện chi tiết (Plan) và trình người dùng review. BẮT BUỘC phải được người dùng đồng ý mới được thực hiện.**
2. **Thực hiện**:
    - Bám sát router theo yêu cầu.
    - Sử dụng thư viện clerk, cài đặt và cấu hình thư viện để phục vụ cho chức năng signin/signup theo các hướng dẫn bên dưới.
3. **Kiểm tra**: Chạy test UI.

## Hướng dẫn chi tiết Clerk
